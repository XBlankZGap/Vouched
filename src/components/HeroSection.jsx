...
const HeroSection = () => {
  return (
    <section
      id="hero"
      className="pt-32 pb-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-100 to-white min-h-screen flex items-center justify-center relative rounded-[1.5rem] shadow-2xl"
    >
